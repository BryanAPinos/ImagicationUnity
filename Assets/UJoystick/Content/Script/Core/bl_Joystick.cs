...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public void OnDrag(PointerEventData data)
    {
        ...
        if (data.pointerId == lastId)
        {
            ...
            // Vector3 direction = position - DeathArea;
            // // Ensure that the stick stays within the range of the ring
            ...
            // else
            // {
            //     // Clamp the stick to the edge of the ring
            //     StickRect.position = DeathArea + direction.normalized * radio;
            // }
        }
    }
