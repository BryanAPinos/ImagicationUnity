        ...
        if (uLocalVideoImage != null)
        {
            if (frame != null)
            {
                ...
                */
                ...
                if (uLocalVideoImage.texture == this.uNoCameraTexture)
                {
                    uLocalVideoImage.texture = null;
                }
                UnityMediaHelper.UpdateRawImage(uLocalVideoImage, frame);
    ...
    public virtual void UpdateRemoteTexture(IFrame frame)
    {
        if (uRemoteVideoImage != null)
        {
            if (frame != null)
            {
                ...
                */
                if (uRemoteVideoImage.texture == this.uNoCameraTexture)
                {
                    uRemoteVideoImage.texture = null;
                }
                UnityMediaHelper.UpdateRawImage(uRemoteVideoImage, frame);
