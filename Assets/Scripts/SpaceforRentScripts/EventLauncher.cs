...
{
    public class EventLauncher : MonoBehaviourPunCallbacks
    {
		...
		public void Connect()
		{
			...
			AnalyticsService.Instance.CustomData("launcherConnect", parameters); 

			// Optional - You can call Events.Flush() to send the event immediately
			// AnalyticsService.Instance.FlushEvents();
			//Analytics
